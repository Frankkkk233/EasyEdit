...
def layer_stats(
    ...
    def get_ds():
        ...
        # )
        raw_ds = load_from_disk('/data0/liuyuhuan/liuyuhuan/repo/EasyEdit/data/wikitext-103-raw-v1')
            ...
            for batch in batch_group:
                ...
                try:
                    ...
                    if 'CUDA out of memory' in str(e):
                        print(f"CUDA out of memory, clearing cache and skipping this batch.")
                    #     # torch.cuda.empty_cache()  # 清理显存缓存
                        continue  # 跳过本次循环，继续下一个batch或者epoch
    return stat
