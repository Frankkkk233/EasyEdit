...
def execute_memit(
    ...
    for i, request in enumerate(requests):
        ...
        if '{}' not in request['prompt']:
            ...
            requests[i]['prompt'] = requests[i]['prompt'].replace(requests[i]['subject'], '{}')   #extract subject
    ...
    for i, layer in enumerate(hparams.layers):
        ...
        layer_ks = compute_ks(model, tok, requests, hparams, layer, context_templates).T  #抽出key
